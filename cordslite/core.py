...
__all__ = ['DISCORD_WEB', 'depoch', 'evt_typs', 'spf', 'sr', 'n_chs', 'frame_bytes', 'DiscordClient', 'DiscordError',
           ...
           'Attachment', 'User', 'Member', 'Members', 'lbl', 'Webhook', 'Webhooks', 'GatewayClient', 'Op', 'Event',
           'VoiceClient', 'VoiceUDP', 'silence', 'pcm2frames', 'file2pcm', 'Bot']
